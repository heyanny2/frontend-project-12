...
export const currentChannel = (state) => channelsSelector.selectById(state, state.channels.currentChannelId);
export const channelsNames = (state) => channelsSelector.selectAll(state).map((channel) => channel.name);
