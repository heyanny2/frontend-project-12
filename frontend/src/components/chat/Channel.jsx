...
const Channel = ({ channel, onClick }) => {
  ...
  return (
    <li className="nav-item w-100 channel" key={channel.id}>
      ...
      <div x-placement="bottom-end" aria-labelledby="react-aria4736936024-3" className="dropdown-menu" data-popper-reference-hidden="false" data-popper-escaped="false" data-popper-placement="bottom-end">
        <Link className="dropdown-item" role="button" href="#" onClick={handleDeleteChannel}>{t('channel.removeChannel')}</Link>
