...
const DeleteChannelModalWindow = () => {
    ...
    <Modal show={isModalWindowOpen}>
        <div className="modal-header">
            ...
            <button type="button" className="btn-close" aria-label="Close" onClick={handleDeleteChannel}></button>
        </div>
        ...
        <div class="d-flex justify-content-end">
                ...
                <ModalButtton title={t('modal.removeBtn')} priority={true} onClick={handleCloseModalWindow}/>
        </div>        
        </div>
    </Modal>
    );
